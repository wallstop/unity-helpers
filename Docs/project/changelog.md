...
- Comprehensive documentation in the [Inspector guides](../features/inspector/inspector-overview.md)
...
- Auto-generated performance documentation in [Random Performance](../performance/random-performance.md)
...
- Add comprehensive inspector attribute guides:
  - [Inspector Overview](../features/inspector/inspector-overview.md) - Feature overview and quick start
  - [Inspector Button Guide](../features/inspector/inspector-button.md) - WButton attribute deep dive
  - [Inspector Grouping Attributes](../features/inspector/inspector-grouping-attributes.md) - WGroup and WFoldoutGroup usage
  - [Inspector Conditional Display](../features/inspector/inspector-conditional-display.md) - WShowIf patterns
  - [Inspector Selection Attributes](../features/inspector/inspector-selection-attributes.md) - WEnumToggleButtons and dropdowns
  - [Inspector Settings](../features/inspector/inspector-settings.md) - Settings system configuration
- Add [Serialization Types Reference](../features/serialization/serialization-types.md) - Complete serializable types reference
- Add [Roadmap](../overview/roadmap.md) - Planned features and priorities
- Add [Third-Party Notices](third-party-notices.md) - License attributions
- Update the [Feature Index](../overview/index.md) with new features
- Enhanced the [README](../../README.md) with feature highlights and badges
...
- [AGENTS Guide](../../AGENTS.md) for LLM-assisted development guidelines
