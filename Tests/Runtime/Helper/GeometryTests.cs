namespace WallstopStudios.UnityHelpers.Tests.Helper
{
    ...
    public sealed class GeometryTests
    {
        ...
        {
            Rect rect1 = new Rect(0, 0, 5, 5);
            Rect rect2 = new Rect(3, 3, 5, 5);
        ...
        {
            Rect rect1 = new Rect(0, 0, 5, 5);
            Rect rect2 = new Rect(10, 10, 5, 5);
            Rect rect3 = new Rect(-5, -5, 3, 3);
        ...
        {
            Rect rect1 = new Rect(5, 5, 0, 0);
            Rect rect2 = new Rect(10, 10, 0, 0);
            IEnumerable<Rect> rects = new[] { rect1, rect2 };
            Rect result = rects.Accumulate();
        ...
        {
            Rect rect1 = new Rect(-5, -5, 10, 10);
            Rect rect2 = new Rect(3, 3, 7, 7);
            IEnumerable<Rect> rects = new[] { rect1, rect2 };
            Rect result = rects.Accumulate();
        ...
        {
            Rect rect1 = new Rect(0, 0, 10, 10);
            Rect rect2 = new Rect(100000, 100000, 5, 5);
            IEnumerable<Rect> rects = new[] { rect1, rect2 };
            Rect result = rects.Accumulate();
        ...
        #region IsAPointLeftOfVectorOrOnTheLine Vector2 Tests
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2VerticalLine()
        {
            ...
            Vector2 b = new Vector2(5, 10);
            Vector2 p = new Vector2(3, 5);
            float result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
        ...
        {
            Vector2 a = new Vector2(0, 0);
            Vector2 b = new Vector2(100000, 0);
            Vector2 p = new Vector2(50000, 10000);
            float result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
        ...
        #region IsAPointLeftOfVectorOrOnTheLine Vector3 Tests
        ...
        {
            Vector3 a = new Vector3(0, 0, 5);
            Vector3 b = new Vector3(10, 0, 10);
            Vector3 p = new Vector3(5, 5, 100);
            float result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
        ...
        {
            Vector3 a = new Vector3(3, 4, 7);
            Vector3 b = new Vector3(10, 8, 2);
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector3PointIsB()
        {
            ...
            Vector3 b = new Vector3(10, 8, 1);
            Vector3 p = new Vector3(10, 8, 1);
            float result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.AreEqual(0, result, "Point at position 'b' should return 0.");
        }
        ...
        #region IsAPointLeftOfVectorOrOnTheLine Vector2Int Tests

        [Test]
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntPointOnLeft()
        {
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(10, 0);
            Vector2Int p = new Vector2Int(5, 5);
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntPointOnLine()
        {
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(10, 0);
            Vector2Int p = new Vector2Int(5, 0);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.AreEqual(0, result, "Point on the line should return 0.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntPointIsA()
        {
            ...
            Vector2Int b = new Vector2Int(10, 8);
            Vector2Int p = new Vector2Int(3, 4);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.AreEqual(0, result, "Point at position 'a' should return 0.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntPointIsB()
        {
            Vector2Int a = new Vector2Int(3, 4);
            Vector2Int b = new Vector2Int(10, 8);
            Vector2Int p = new Vector2Int(10, 8);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.AreEqual(0, result, "Point at position 'b' should return 0.");
        }
        ...
        {
            Vector2Int a = new Vector2Int(-10, -10);
            Vector2Int b = new Vector2Int(-5, -5);
            Vector2Int p = new Vector2Int(-8, -6);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(result > 0, "Point should be to the left with negative coordinates.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntVerticalLine()
        {
            ...
            Vector2Int b = new Vector2Int(5, 10);
            Vector2Int p = new Vector2Int(3, 5);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(result > 0, "Point to the left of vertical line should return positive.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntVerticalLinePointOnRight()
        {
            Vector2Int a = new Vector2Int(5, 0);
            Vector2Int b = new Vector2Int(5, 10);
            Vector2Int p = new Vector2Int(8, 5);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(
                result < 0,
                "Point to the right of vertical line should return negative."
        ...
        {
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(10, 10);
            Vector2Int p = new Vector2Int(5, 6);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(result > 0, "Point above diagonal should be to the left.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntDiagonalLineBelow()
        {
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(10, 10);
            Vector2Int p = new Vector2Int(6, 5);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(result < 0, "Point below diagonal should be to the right.");
        }
        ...
        {
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(10000, 0);
            Vector2Int p = new Vector2Int(5000, 1000);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
            Assert.IsTrue(result > 0, "Point should be to the left with large coordinates.");
        }
        ...
        public void IsAPointLeftOfVectorOrOnTheLineVector2IntOverflowScenario()
        {
            ...
            Vector2Int a = new Vector2Int(0, 0);
            Vector2Int b = new Vector2Int(30000, 30000);
            Vector2Int p = new Vector2Int(15000, 15001);
            int result = Geometry.IsAPointLeftOfVectorOrOnTheLine(a, b, p);
