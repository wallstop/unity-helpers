namespace WallstopStudios.UnityHelpers.Tests.CustomDrawers
{
    ...
    //
    //     [UnityTest]
    //     public IEnumerator TryGetImGuiStateInfoExposesRowMetrics()
    //     {
    //         string sessionKey = GetSessionKey(_inlineProperty);
    //         WInLineEditorPropertyDrawer drawer = new();
    //         GUIContent label = new GUIContent(_inlineProperty.displayName);
    //         float height = drawer.GetPropertyHeight(_inlineProperty, label);
    //         Rect rect = new Rect(0f, 0f, 420f, height);
    //
    //         bool executed = false;
    //         yield return TestIMGUIExecutor.Run(() =>
    //         {
    ...
    //
    //         Assert.IsTrue(
    //             WInLineEditorPropertyDrawer.SetRowMeasurementsForTesting(
    //                 sessionKey,
    //                 640f,
    //                 320f,
    //                 true,
    ...
    //             Is.True
    //         );
    //         Assert.That(info.HasMeasuredRows, Is.True);
    //         Assert.That(info.MaxMeasuredRowWidth, Is.EqualTo(640f));
    //         Assert.That(info.MaxViewportFitRowWidth, Is.EqualTo(320f));
    //         Assert.That(info.AnyRowOverflow, Is.True);
    //         Assert.That(info.RowSampleCount, Is.EqualTo(6));
    //         Assert.That(info.LastViewportWidth, Is.EqualTo(300f));
    //         Assert.That(info.RowMetricsInferred, Is.False);
    //     }
    //
    //     [UnityTest]
    //     public IEnumerator HorizontalScrollOffsetPersistsWhileOverflowing()
    //     {
    //         string sessionKey = GetSessionKey(_inlineProperty);
    //         WInLineEditorPropertyDrawer drawer = new();
    //         GUIContent label = new GUIContent(_inlineProperty.displayName);
    //         float height = drawer.GetPropertyHeight(_inlineProperty, label);
    //         Rect rect = new Rect(0f, 0f, 380f, height);
    //
    ...
    //         );
    //
    //         Assert.That(info.HorizontalScrollOffset, Is.GreaterThan(60f));
    //         Assert.That(info.RowMetricsInferred, Is.True);
    //     }
    //
    //     [UnityTest]
